...
def home(request):
    ...
    if 'city' in request.POST:
        ...
        city = 'indore'
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=cea290028800dec65c5cacee69c757e8'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyD2nhIAW5ndFucRTFtbwfas6O-cJ_hmviA'

    SEARCH_ENGINE_ID = '650b29f9144154a93'
